...
public class JpushClientUtil {
	private final static String appKey = "719f3938a75d1f29132014f8";
    private final static String masterSecret = "aa89bd84b767cb249e4dfd32";
...
//        System.out.println("----------buildPushObject_ios_registrationId_alertWithTitle");
    ...
    public static void main(String[] args){
    	try{
        JpushClientUtil.sendToAllIos("中迪用车","还车提醒：尊敬的用户，您有一个使用中的订单超过24小时没有还车，请确认您是否需要继续用车并及时还车，谢谢","","");
    	}catch(Exception e){
    		e.printStackTrace();
    	}
    }
